    ...
    <div class="container my-24 mx-auto md:px-6">
      <section class="mb-32 text-center">
        <h2 class="mb-12 text-3xl font-bold">
          Есть веские причины для
          <u class="text-primary dark:text-primary-400 tracking-in-expand">гордости</u>
        </h2>
        <div class="grid md:grid-cols-3 lg:gap-x-12">
          ...
          <div class="mb-12 md:mb-0">
            ...
            <h5 class="text-lg font-medium text-neutral-500 dark:text-neutral-300">
              Одна из самых лучших в Казахстане
            </h5>
          </div>
          ...
          <div class="mb-12 md:mb-0">
            ...
            <h5 class="text-lg font-medium text-neutral-500 dark:text-neutral-300">
              Большой процент трудоустройства
            </h5>
          </div>
        </div>
      </section>

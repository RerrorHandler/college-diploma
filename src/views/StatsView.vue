<template>
    <main class="p-6 sm:p-10 space-y-6">
      <div class="flex flex-col space-y-6 md:space-y-0 md:flex-row justify-between">
        <div class="mr-6">
          <h1 class="text-4xl font-semibold mb-2">Твоё пространство</h1>
          <h2 class="text-gray-600 ml-0.5">Статистика</h2>
        </div>
      ...
      <section class="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
        <div class="flex items-center p-8 bg-white shadow rounded-lg">
          ...
          <div>
            ...
            <span class="block text-gray-500">Студентов</span>
          </div>
        </div>
        <div class="flex items-center p-8 bg-white shadow rounded-lg">
          ...
          <div>
            <span class="block text-2xl font-bold">{{randomNumber}}</span>
            <span class="block text-gray-500">Средняя оценка</span>
          </div>
        </div>
        <div class="flex items-center p-8 bg-white shadow rounded-lg">
          ...
          <div>
            <span class="inline-block text-2xl font-bold">{{randomNumber}}</span>
            <span class="inline-block text-xl text-gray-500 font-semibold">({{randomNumber + 32}}%)</span>
            <span class="block text-gray-500">Хуже чем у остальных</span>
          </div>
        </div>
        <div class="flex items-center p-8 bg-white shadow rounded-lg">
          <div class="inline-flex flex-shrink-0 items-center justify-center h-16 w-16 text-blue-600 bg-blue-100 rounded-full mr-6">
          ...
          <div>
            <span class="block text-2xl font-bold">{{randomNumber}}%</span>
            <span class="block text-gray-500">Домашнее задание</span>
          </div>
        </div>
      </section>
      <section class="grid md:grid-cols-2 xl:grid-cols-4 xl:grid-rows-3 xl:grid-flow-col gap-6">
        <div class="flex flex-col md:col-span-2 md:row-span-2 bg-white shadow rounded-lg">
          <div class="px-6 py-5 font-semibold border-b border-gray-100">Домашнее задание</div>
          <div class="p-4 flex-grow">
            <div class="flex items-center justify-center h-full px-4 py-16 text-gray-400 text-3xl font-semibold bg-gray-100 border-2 border-gray-200 border-dashed rounded-md">Домашнее задание</div>
          </div>
        </div>
        <div class="flex items-center p-8 bg-white shadow rounded-lg">
          ...
          <div>
            ...
            <span class="block text-gray-500">Занятий осталось</span>
          </div>
        </div>
        <div class="flex items-center p-8 bg-white shadow rounded-lg">
          ...
          <div>
            ...
            <span class="block text-gray-500">Часов лекций</span>
          </div>
        </div>
        ...
        <div class="flex flex-col row-span-3 bg-white shadow rounded-lg">
          <div class="px-6 py-5 font-semibold border-b border-gray-100">Доска обьявлений</div>
          <div class="p-4 flex-grow">
            <div class="flex items-center justify-center h-full px-4 py-24 text-gray-400 text-3xl font-semibold bg-gray-100 border-2 border-gray-200 border-dashed rounded-md">Доска обьявлений</div>
          </div>
        </div>
      </section>
    </main>
